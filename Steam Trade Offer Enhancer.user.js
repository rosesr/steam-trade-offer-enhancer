                ...
                offers: {
                    ...
                    identifiers: {
                        ...
                        getItemAttributes: function(item) {
                            ...
                            // has a craft number that displays in game (<100)
                            if (/.* #\d+$/.test(item.name)) {
                        ...
                        addAttributesToElement: function(itemEl, attributes) {
                            ...
                            if (attributes.lowcraft) {
                                ...
                                craftEl.innerHTML=attributes.lowcraft;
                                craftEl.classList=classes;
                                craftEl.setAttribute('style', `color:#${attributes.color};
                                                     top: -25px;
                                                     left: -2px;
                                                     text-align: end;
                                                     font-size: 18px;
